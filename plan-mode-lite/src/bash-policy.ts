/**
 * Read-only command policy for Plan mode.
 *
 * Ported from @narumitw/pi-plan-mode v0.58.3 (src/tool-policy.ts), MIT License,
 * Copyright (c) narumiruna — https://github.com/narumiruna/pi-extensions
